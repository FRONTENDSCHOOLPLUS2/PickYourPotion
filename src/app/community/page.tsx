    ...
    <main>
      <div className="">
        <div className="absolute">
          <Image src={dummyImage} width={428} height={449} alt="막걸리 이미지" />
        </div>
        <div className="relative bg-white top-20 round">
          <div className="mx-6 shadow-md px-18 round">
            <h1 className="titleMedium">로렘 입숨 생막걸리</h1>
            <p className="content text-darkGray text-wrap mt-2.5">
            ...
            <div className="mt-3">
              <span className="px-[7px] py-[5px] text-darkGray bg-lightGray mr-4 rounded-b-">
                소고기 육전
              </span>
            ...
            <Link href="#">
              <div className="flex flex-row">
                ...
                <div className="flex flex-col mt-3 ml-5">
                  <p className="contentMedium">느린마을 막걸리(겨울)</p>
                  <span className="">
                    <p className="text-gray description">17도</p>
                  </span>
                  <p className="text-gray description">양조장</p>
                  <p className="text-black contentMedium">32,000원</p>
                </div>
              </div>
            </Link>
          </div>
